 ...
 *   "requestId": "req_xxx",
 *   "analysis": {
 *     "agent": "py|vigil|quill|savy|main",
...
// Note: These should match your openclaw-office.config.json agents
const AGENTS = {
  main: { name: 'Main', role: 'Main Orchestrator (handles general tasks)' },
